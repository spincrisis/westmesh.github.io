      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <span className="font-mono font-bold text-mw-cyan text-xl tracking-wider">WESTMESH</span>
            </div>
        ...
        <div className="border-t border-mw-cyan pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="font-mono text-xs text-mw-gray max-w-3xl text-center sm:text-left leading-relaxed">
            &copy; 2026 WestMesh. All rights reserved. WestMesh is a decentralized community that organizes
            information. The network is supplied, operated, and maintained by independent users and members, and WestMesh
            ...
            express or implied. WestMesh is not intended to be used as a life-saving or emergency service. In an
            emergency, dial 911 or your local emergency number. Your use of this network is solely at your own risk.
          </p>
          <div className="flex items-center gap-4 shrink-0">
            <span className="font-mono font-bold text-mw-cyan text-sm tracking-wider">WESTMESH</span>
          </div>
        </div>
      </div>
    </footer>
